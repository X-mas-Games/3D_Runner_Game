...
using AnimationBaseMovement.InputSystem;
using UnityEngine;
using UnityEngine.Serialization;

namespace AnimationBaseMovement
{
    public class PlayerAnimationController : MonoBehaviour
    {
        ...
        private void EnableLockOn(bool enable)
        {
            ...
            cameraControllers.LockOn(enable, _targetLockOnPos);
        ...
        private void CalculateInput()
        {
            ...
            _moveDirection = (cameraControllers.GetCameraForwardZeroedYNormalised() * _inputReader._moveComposite.y)
                + (cameraControllers.GetCameraRightZeroedYNormalised() * _inputReader._moveComposite.x);
        }
        ...
        ///         Calculate what the current Movement gait is (Walk, Run, Sprint)
        ...
        /// <summary>
        ///     Calculates the face move direction based on the Movement of the character.
        /// </summary>
        private void FaceMoveDirection()
        {
            ...
            _cameraForward = cameraControllers.GetCameraForwardZeroedYNormalised();
        ...
        private void CalculateRotationalAdditives(bool leansActivated, bool headLookActivated, bool bodyLookActivated)
        {
            ...
            float cameraTilt = cameraControllers.GetCameraTiltX();
        ...
        private void UpdateBestTarget()
        {
            ...
            else
            {
                ...
                foreach (GameObject target in _currentTargetCandidates)
                {
                    ...
                    Vector3 targetDirection = target.transform.position - cameraControllers.GetCameraPosition();
                    float angleInView = Vector3.Dot(targetDirection.normalized, cameraControllers.GetCameraForward());
        ...
        /// <summary>
        ///     Sets up the Movement state upon entry.
        /// </summary>
        ...
        /// <summary>
        ///     Performs the required actions when exiting the Movement state.
        /// </summary>
        ...
        /// <summary>
        ///     Moves from the Movement to the jump state.
        /// </summary>
        ...
        /// <summary>
        ///     Moves from the crouch state to the Movement state.
        /// </summary>
